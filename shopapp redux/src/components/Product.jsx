...
const removeFromCart = () => {
  ...
  return (
    ...
    ease-in  hover:shadow-[rgba(0,_0,_0,_0.4)_0px_30px_90px]  gap-3 p-4 mt-10 ml-5 rounded-xl shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]'>
      ...
      <div className='flex justify-between gap-16 items-center w-full mt-5'>
...

        {
          ...
          : 
          (<button className='text-gray-700 border-2 border-gray-700 rounded-full font-semibold text-[12px] 
          p-1 px-2 uppercase hover:bg-gray-700 hover:text-white transition-all duration-300 ease-in'
