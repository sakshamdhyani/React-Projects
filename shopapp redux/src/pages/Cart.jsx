...
const Cart = () => {
  ...
  useEffect(() => {
    ...
    let totalPrice = cart.reduce ( (accumulator , currentItem) => accumulator + currentItem.price , 0).toFixed(2);
    setTotalAmount(totalPrice) // 0 here is the initial value of accumulator
      ...
      (
        <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-center">
          ...
          <div className="w-[100%] md:w-[60%] flex flex-col p-2">
            ...
            {cart.map((post , index) => (
              <CartItem post={post} key={post.id} index = {index} />
            ))}
